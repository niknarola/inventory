...
<form id="print-preview" method="post" name="print-preview">
        ...
        <div class="col-md-12">
            <div class="hidden-print" style="margin-bottom: 5px;">
                <div class="text-center">
                    <button type="submit" name="printall" value="printall" class="btn btn-info print_all hidden-print">Print All</button>
                </div>
            </div>
            <div class="printarea">
...
<hr>
                    ...
                    <div class="row text-center barcode_labels">
                        ...
                        <div class="row">
                            ...
                            <div class="row"><button name="print2" value="print2" type="submit" class="btn btn-info print_btn hidden-print">Print</button></div>
                        </div>
                    </div>
                </div>
                <hr>
