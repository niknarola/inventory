				...
				<tr>
					<th style="padding:0 0 40px; width:150px; text-align:left;">
						<h2 style="margin:0; padding:0; text-align:center;">
							...
							<small style="background: #000; color: #fff; font-size: 44px; padding: 10px 10px; line-height: 40px; display: block; text-align: center; text-transform: uppercase; width: 160px; text-align: right; padding:10px 10px; display:block;"><?=$print_labels['conditions']?></small>
						</h2>
					</th>
					<th style="padding:0 0 40px; text-align:right;">
						<h6 style="margin:0; padding:0;">
							...
							<span style="display:block; text-align: right; padding: 3px 10px 0 0; font-size: 13px; line-height: 100%; display:block;"><?php echo date('m/d/Y');?></span>
						</h6>
					</th>
				</tr>
			</thead>
