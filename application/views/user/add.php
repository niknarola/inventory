					...
					<div class="row">
						<div class="col-md-10 col-md-offset-1">
							<div class="form-group">
								<label>Name:</label>
								<input type="text" name="name" value="<?php echo ($user!='') ? $user['name'] : ''; ?>" class="form-control" placeholder="John Kay" required>
							</div>
							<div class="form-group">
								<label>Email:</label>
								<input type="email" value="<?php echo ($user!='') ? $user['email'] : ''; ?>" name="email" class="form-control" placeholder="john@gmail.com" required> 
							</div>
							<div class="form-group">
