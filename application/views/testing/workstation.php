<div class="row">
	<div class="">
		<form method="post" action="<?= $admin_prefix; ?>testing/workstation" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="col-md-6">
										...
										<div class="input-group">
											<span class="input-group-addon">
												<input type="checkbox" value="1" name="secondary_storage" class="checkbx secondary_storage">
											</span>
											<input type="text" readonly="true" value="Secondary Storage" class="form-control"> 
										</div>
										<div class="input-group">
											<span class="input-group-addon">
    ...
    function get_product_details(){
		...
		if(part!='' && serial!=''){
			...
			.done(function(response) {
				...
				$('.secondary_storage').prop('checked', false);
				if(response.product.secondary_storage==1){
					$('.secondary_storage').prop('checked', true);
				}
