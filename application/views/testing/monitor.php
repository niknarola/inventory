<div class="row">
	<div class="">
		<form method="post" action="<?= $admin_prefix; ?>testing/monitor" id="monitor" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<select name="category1" class="category1 form-control" onchange="get_sub_categories(this.value, 'category2')">
										<?php foreach ($categories as $key => $value) { ?>
											<option <?php echo ($key == 5) ? 'selected' : ''; ?> value="<?= $key ?>"><?= $value ?></option>
										<?php } ?>
									</select>
								</div>
								</div>
...
<div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
                ...
                <div class="row accessories">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control cd_soft" name="access_type_id[]" value="" placeholder="" />
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control cd_soft" name="access_name_id[]" value="" placeholder="" />
                        </div>
                    </div>
            ...
            <center><button type="button" class="btn btn-info btn-lg add_ok" data-toggle="modal" data-target="">Add</button></center>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
	    ...
	    get_sub_categories(5, 'category2');
		...
		if(serial!=''){
			...
			.done(function(response) {
				if(response.status==0){
					...
					$('.category1').val(5).trigger('change');
					get_sub_categories(5, 'category2');
