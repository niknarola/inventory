<div class="row">
	<div class="">
		<form method="post" action="<?= $admin_prefix; ?>testing/tablet" enctype="multipart/form-data">
								...
								<div class="col-md-4">
									<div class="col-md-6">
										...
										<div class="input-group">
											...
											<input type="text" readonly="true" value="Webcam" class="form-control"> 
										</div>
										<div class="input-group">
											<span class="input-group-addon">
												<input type="checkbox" value="1" name="tgfg_capable" class="checkbx tgfg_capable">
											</span>
											<input type="text" readonly="true" value="3G/4G Capable" class="form-control"> 
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="input-group">
											<span class="input-group-addon">
												<input type="checkbox" value="1" name="stylus" class="checkbx stylus">
											</span>
											<input type="text" readonly="true" value="Stylus" class="form-control"> 
										</div>
										<div class="input-group">
											<span class="input-group-addon">
										...
										<div class="input-group">
											<span class="input-group-addon">
												<input type="checkbox" value="1" name="travel_keyboard" class="checkbx travel_keyboard">
											</span>
											<input type="text" readonly="true" value="Travel Keyboard" class="form-control"> 
										</div>
										<div class="input-group">
											<span class="input-group-addon">
												<input type="checkbox" value="1" name="power_keyboard" class="checkbx power_keyboard">
											</span>
											<input type="text" readonly="true" value="Power Keyboard" class="form-control"> 
										</div>
									</div>
								</div>
								<div class="row">
    ...
    function get_product_details(){
		...
		if(part!='' && serial!=''){
			...
			.done(function(response) {
				...
				$('.stylus').prop('checked', false);
				if(response.product.stylus==1){
					$('.stylus').prop('checked', true);
				}
				$('.travel_keyboard').prop('checked', false);
				if(response.product.travel_keyboard==1){
					$('.travel_keyboard').prop('checked', true);
				}
				$('.power_keyboard').prop('checked', false);
				if(response.product.power_keyboard==1){
					$('.power_keyboard').prop('checked', true);
				}
