					...
					<hr>
						<div class="row">
                            ...
                            <div class="col-md-4">
								<div class="form-group">
									<label>Model:</label>
									<input type="text" name="model" value="" class="form-control model">
								</div>
							</div>
						</div>
							<div class="col-md-4">
							...
							<div class="row">
								...
								<div class="form-group">
									...
									<select name="final_condition" data-placeholder="Select Original Condition" class="form-control select final_condition">
										<?php foreach ($original_condition as $key => $value) { ?>
											<option value="<?= $key; ?>"><?= $value; ?></option>
										<?php }  ?>
									</select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Grading note:</label>
                                    <textarea name="grading_notes" class="form-control grading_notes"></textarea>
                                </div>
                            </div>
                            <hr>
							<div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>OS:</label>
                                    <input type="text" class="form-control os" name="os" value="" placeholder="OS">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>CPU:</label>
                                    <textarea name="cpu" class="form-control cpu"></textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Memory:</label>
                                    <input type="text" class="form-control memory" name="memory" value="" placeholder="memory">
                                </div>
                            </div>
                            <div class="col-md-12">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Storage:</label>
                                    <textarea name="storage" class="form-control storage"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="graphics" class="form-control graphics"></textarea>
                                </div>
                            </div>
						...
						<div class="col-md-12">
                            ...
                            <div class="col-md-4"> 
                                <div class="input-group">
                                        ...
                                        <div class="input-group">
										<span class="input-group-addon">
											<input type="radio" value="1" name="qcno" class="checkbx no">
										</span>
										<label class="check_label">No</label>
                                        </div>
                                        </div>
    ...
    function get_product_details(){
		...
		if(serial!=''){
			...
			.done(function(response) {
                ...
                $('textarea.cpu').html(response.product.cpu);
