<div class="row">
	<div class="">
		<form method="post" action="<?= $admin_prefix; ?>testing/thin_client" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="row">
									<div class="form-group">
										...
										<textarea name="additional_features" rows="5" class="form-control additional_features"></textarea>
									</div>
								</div>
									</div>
									<div class="col-md-6">
