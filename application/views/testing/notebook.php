...
<div class="row">
    <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="new_serial" name="new_serial" value="" class="form-control new_serial">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="row storage_row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group" id="ssd-check0">
                                                <span class="input-group-addon ">
                                                    <input type="checkbox" value="1" name="ssd0" class="ssd checkbx">
                                                </span>
                                                <label class="check_label" id="ssd-lbl0">SSD</label>
                                    ...
                                    <div class="row graphics_row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group" id="dedicated-check0">
                                                <span class="input-group-addon">
                                                    <input type="checkbox" value="1" name="dedicated0" class="dedicated checkbx">
                                                </span>
                                                <label class="check_label" id="dedicated-lbl0">Dedicated</label>
        ...
        <div class="row storage1" style="display:none;">
            ...
            <div class="col-md-5">
                <div class="input-group" id="ssd-check">
                    <span class="input-group-addon">
                        <input type="checkbox" value="1" name="ssd" class="ssd checkbx">
                    </span>
                    <label class="check_label" id="ssd-lbl">SSD</label>
                    <!-- <input type="text" class="form-control" value="SSD" readonly="true" /> -->
                </div>
            </div>
        </div>
        <div class="row graphics1" style="display:none;">
            ...
            <div class="col-md-5">
                <div class="input-group" id="dedicated-check">
                    <span class="input-group-addon">
                        <input type="checkbox" value="1" name="dedicated" class="dedicated checkbx">
                    </span>
                    <label class="check_label" id="dedicated-lbl">Dedicated</label>
                    <!-- <input type="text" class="form-control" value="Dedicated" readonly="true"> -->
                </div>
            </div>
        </div>
...
//  }
                                                            ...
                                                            .done(function (response) {
                                                                if (response.status == 0) {
                                                                    ...
                                                                    if (cpu_array != null) {
                                                                        ...
                                                                        if (cpu_array.length > 0 && $('input.cpu').length != cpu_array.length) {
                                                                    ...
                                                                    if (storage_array != null) {
                                                                        ...
                                                                        if (storage_array.length > 0 && $('input.storage').length != storage_array.length) {
                                                                    ...
                                                                    if (ssd_array != null) {
                                                                        ...
                                                                        if ((ssd_array.length > 1 || ssd_array.length > 0) && $('input.ssd').length != ssd_array.length) {
                                                                            console.log('here==>',ssd_array.length);
                                                                            for (var i = ssd_array.length; i < $('input.ssd').length; ++i) {
                                                                                console.log('i==>',i);
                                                                                console.log("$('input.ssd').length",$('input.ssd').length);
                                                                                console.log($('[name="ssd' + i + '"]'));
                                                                                console.log($('#ssd-check' + i));
                                                                                console.log($('#ssd-lbl' + i));
                                                                                $('[name="ssd' + i + '"]').remove();
                                                                                $('#ssd-check' + i).remove();
                                                                                $('#ssd-lbl' + i).remove();
                                                                            }
                                                                    ...
                                                                    if (graphics_array != null) {
                                                                        ...
                                                                        if (graphics_array.length > 0 && $('input.stographicsage').length != graphics_array.length) {
                                                                    ...
                                                                    if (dedicated_array != null) {
                                                                        ...
                                                                        if (dedicated_array.length > 0 && $('input.dedicated').length != dedicated_array.length) {
                                                                            for (var i = dedicated_array.length; i < $('input.dedicated').length; ++i) {
                                                                                $('[name="dedicated' + i + '"]').remove();
                                                                                $('#dedicated-check' + i).remove();
                                                                                $('#dedicated-lbl' + i).remove();
                                                                            }
                                                                        }
                                                                    ...
                                                                    $('select.warranty').val(response.product.warranty);
                                        ...
                                        $('.add_more_storage').on('click', function () {
                                            ...
                                            $('.storage1').find('#ssd-check').attr('id', 'ssd-check' + len);
                                            $('.storage1').find('#ssd-lbl').attr('id', 'ssd-lbl' + len);
                                        ...
                                        $('.add_more_graphics').on('click', function () {
                                            ...
                                            $('.graphics1').find('#dedicated-check').attr('id', 'dedicated-check' + len);
                                            $('.graphics1').find('#dedicated-lbl').attr('id', 'dedicated-lbl' + len);
